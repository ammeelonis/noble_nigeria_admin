 <!-- Popular News Start -->
                    <div class="mb-3">
                        ...
                        if (isset($trending_chunk)) {

                            foreach($trending_chunk as $trending_row){

                                echo ' <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                <div class="col-md-4 px-0">
                                    <img class="img-fluid" src="admin/images/' .  $trending_row["image_1"]  . '" alt="" style="object-fit:cover; height:100%; overflow:hidden;">
                                </div>
                                    ...
                                    <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="single.php?id=' .  $trending_row["id"]  . '">' .  $trending_row["title"]  . '</a>
                                </div>
                            </div>'; }
